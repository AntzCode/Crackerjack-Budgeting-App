...
export class Expense extends Model {
    ...
    @field('expense_total') expenseTotal
    ...
    @writer
    async delete() {
        let deletedForecasts = (await this.database.get<Forecast>(Forecast.table).query(Q.where('expense_id', this.id)))
